...
def inference(pose_model,
    ...
    image_orig = image_crop.copy()
    h, w = image_orig.shape[:2]
    test_image = image_crop.copy()
...
def run_pose_estimation(image: np.ndarray, pose_model):
    preprocess_data = {}
    ...
    if type == "body":
        ...
        onnx_model_path = "body_deeppose_res50_coco_256x192.onnx"
        heatmap_size = None
